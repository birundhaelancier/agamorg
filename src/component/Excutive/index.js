...
import { AddExcutive } from '../../Redux/Action/CreateActions'
...
const EnquiryArea = (props) => {
    ...
    mother_name: {  value: "", validation: [{ name: "required" }], error: null, errmsg: null},
    ...
    experience: {  value: "", validation: [{ name: "required" }], error: null, errmsg: null},
    currently: {  value: "", validation: [{ name: "required" }], error: null, errmsg: null},
    })
 
    const onChangeData = (data, key, list) => {
    ...
    const Submit = (e) => {
        ...
        if (filtererr.length > 0) {
            ...
            dispatch(AddExcutive(Detail)).then((res)=>{
                ClearState()
            }) 
        }
        setDetail((prevState) => ({
    ...
    return (
        <>
        <Header/>
            <section id="contact_area" className="ptb-100 farmer_form">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="contact_form_one contact_info_wrapper">
                                <h4 className="text-center">Executive</h4>
                                <form onSubmit={(e)=>Submit(e)} autoComplete="off">
                                    <div className="row">
                                       ...
                                       <div className="col-lg-4 col-md-4 col-sm-4 col-12">
                                        ...
                                        <div className="col-lg-4 col-md-4 col-sm-4 col-12">
                                            <div className="form-group">
                                            <Labelbox type="text" labelname={"Mother Name"}
                                                 changeData={(data) => onChangeData(data, "mother_name")}
                                                 value={Detail.mother_name.value}
                                                 error={Detail.mother_name.error}
                                                 errmsg={Detail.mother_name.errmsg}
                                            />
                                                {/* <input type="text" className="form-control" name="mother_name" value={Detail.mother_name} placeholder="Mother Name" required onChange={onChangeData}/> */}
                                            </div>
                                        </div>
                                        <div className="col-lg-4 col-md-4 col-sm-4 col-12">
                                            <div className="form-group">
                                        ...
                                        <div className="col-lg-4 col-md-4 col-sm-4 col-12">
                                            <div className="form-group formdiv">
                                              <div className='labeltxt'>Have any experience in Agriculture Arban Farming related Business/Job</div>  
                                              <Radio.Group onChange={(e)=>onChangeData(e.target.value,"experience")} name="experience" value={Detail.experience.value}>
                                                     <Radio value={"Yes"}> Yes</Radio>{" "}
                                                     <Radio value={"No"}> No</Radio>
                                             </Radio.Group>
                                             <div className='Errormsg'>{Detail.experience.errmsg}</div>
                                            </div>
                                            <div className="form-group formdiv">
                                              <div className='labeltxt'>Currently, Are you in Agriculture or urban farming related Business/Job</div>  
                                              <Radio.Group onChange={(e)=>onChangeData(e.target.value,"currently")} name="currently" value={Detail.currently.value}>
                                                     <Radio value={"Yes"}> Yes</Radio>{" "}
                                                     <Radio value={"No"}> No</Radio>
                                             </Radio.Group>
                                             <div className='Errormsg'>{Detail.currently.errmsg}</div>
