                                        ...
                                        <div className="col-lg-7 col-md-6">
                                            <div className="offer_modal_left">
                                                ...
                                                <form onSubmit={(e) => { e.preventDefault(); props.stop(); props.start() }}>
                                                    ...
                                                    {/* <div className="input-group mb-3">
                                                        <input type="email" className="form-control" placeholder="Enter Your Pincode" required />
                                                        <div className="input-group-append">
                                                            <button className="theme-btn-one btn-black-overlay btn_sm" type="submit" >Subscribe</button>
                                                        </div>
                                                    </div> */}
                                                    {/* <div className="check_boxed_modal">
                                                        <input className="form-check-input" type="checkbox" id="vehicle1" name="vehicle1" defaultValue="Enter Your Pincode" onClick={props.stop} />
