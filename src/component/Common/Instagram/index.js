      ...
      {props.container ? (
        <section id="instagram_area_one" >
          <div className="container">
            <Heading heading=" LATESTS POST" para="Lorem Ipsum is simply dummy text of the printing and typesetting industry" />
            <div className="row">
        ...
        <section id="instagram_area_one">
          <div className="container-fluid">
            <HeadingTwo heading="LATESTS POST" para="Lorem Ipsum is simply dummy text of the printing and typesetting industry" />
            <div className="row">
              <div className="col-lg-12">
                <div className="instagram_post_slider">
                  <Slider {...settings}>
