...
// import img
import img1 from '../../assets/img/product-image/product8.jpg'
    ...
    <>
      <div className="col-lg-12">
        <div className="blog_single_content">
          <div className="col-lg-12 product-show">
            <div className="col-lg-9">
              {/* <h3 className='productName'>Apple</h3> */}
