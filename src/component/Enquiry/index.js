                            ...
                            <div className="contact_form_one contact_info_wrapper">
                                ...
                                <form onSubmit={(e) => { e.preventDefault(); Swal.fire('Thank You', 'We Got Your Message', 'success') }}>
                                    <div className="row">
                                        ...
                                        <div className="col-lg-3 col-md-3 col-sm-3 col-6">
                                            <div className="form-group">
                                                <input type="number" className="form-control" name="pincode" placeholder="Pincode" required />
                                            </div>
                                        </div>
                                        <div className="col-lg-3 col-md-3 col-sm-3 col-6">
                                            <div className="form-group">
                                        ...
                                        <div className="col-lg-3 col-md-3 col-sm-3 col-6">
                                            <div className="form-group">
                                                <input type="text" className="form-control" name="totalarea" placeholder="Total Area(SQ.FT)" required />
                                            </div>
                                        </div>
                                        <div className="col-lg-3 col-md-3 col-sm-3 col-6">
                                            <div className="form-group">
                                                <input type="number" className="form-control" name="floor" placeholder="Floor" required />
                                            </div>
                                        </div>
                                        <div className="col-lg-3 col-md-3 col-sm-3 col-6">
                                            <div className="fotm-group">
                                                <div className="select-input">
                                                    <select name="package" id="package" placeholder='Package' required>
                                                        <option value="">Select Package</option>
                                                        <option value="one">Package One-10,000</option>
                                                        <option value="two">Package Two-25,000</option>
                                                        <option value="three">Package Three-40,000</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div className="form-group">
                                                <textarea rows="7" className="form-control" name="address" placeholder="Address"></textarea>
                                            </div>
                                        </div>
                                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div className="form-group">
                                                <textarea rows="7" className="form-control" name="description" placeholder="Description"></textarea>
                                            </div>
                                        </div>
                                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <ul>
                                    <li className="address_location">
                                        <div className="contact_widget ">
                                            ...
                                            <p>32, Choto Mirzapur, Ahsan Ahmed Road <br /> Khulna 9100, Madurai</p>
                                        </div>
                                    </li>
                                    <li className="address_location">
